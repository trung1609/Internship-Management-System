...
const StudentsManagement = () => {
    ...
    const fetchAvailableUsers = async () => {
        try {
            const response = await userApi.getAvailableStudents();
                            ...
                            >
                                ...
                                <Stack direction="row" spacing={2} alignItems="center"
                                    ...
                                    <Avatar src={student.avatarUrl}
                                            sx={{width: 56, height: 56, bgcolor: 'primary.main', fontWeight: 'bold'}}>
                                ...
                                <Stack direction="row" spacing={1} sx={{mb: 2, position: 'relative', zIndex: 1}}>
                                    {student.classRoom &&
                                        <Chip label={`Lớp: ${student.classRoom}`} size="small" color="info"
                                              variant="outlined"/>}
                                    {student.major &&
                                        <Chip label={`Ngành học: ${student.major}`} size="small" color="success"
                                              variant="outlined"/>}
                                </Stack>

                                <Stack spacing={1} sx={{position: 'relative', zIndex: 1, mb: 3, flexGrow: 1}}>
                                    <Typography variant="body2"><strong>ID:</strong> {student.studentId || 'N/A'}
                                    </Typography>
                                    <Typography variant="body2"><strong>Email:</strong> {student.email || 'N/A'}
                                    </Typography>
                                ...
                                <Box
                                    sx={{position: 'relative', zIndex: 1, display: 'flex', justifyContent: 'flex-end'}}>
                                    <Button
                                        startIcon={<EditIcon/>}
                                        size="small"
                                        variant="contained"
                                    ...
                                    <Stack spacing={3}>
                                        ...
                                        {!editingStudent && (
                                            <FormControl fullWidth>
                                                <InputLabel id="select-user-id-label">Chọn tài khoản liên kết
                                                    (User)</InputLabel>
                                                <Select
                                                ...
                                                >
                                                    {availableUsers.length === 0 ? (
                                                        <MenuItem disabled value="">
                                                            <em>Không có tài khoản học sinh nào khả dụng</em>
                                                        </MenuItem>
                                                    ) : (
