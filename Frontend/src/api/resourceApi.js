...
export const taskApi = {
    getTasksByAssignment: (assignmentId, page = 0, size = 20) =>
        axiosClient.get(`/api/v1/tasks/assignment/${assignmentId}`, {params: {page, size}}),
    createTask: (data) => axiosClient.post("/api/v1/tasks", data),
    updateTask: (taskId, data) => axiosClient.put(`/api/v1/tasks/${taskId}`, data),
    updateStatus: (taskId, status) => axiosClient.patch(`/api/v1/tasks/${taskId}/status`, null, {params: {status}}),
    deleteTask: (taskId) => axiosClient.delete(`/api/v1/tasks/${taskId}`),
    getComments: (taskId) => axiosClient.get(`/api/v1/tasks/${taskId}/comments`),
    addComment: (taskId, content) => axiosClient.post(`/api/v1/tasks/${taskId}/comments`, { content }),
    getTaskProgress: (assignmentId) => axiosClient.get(`/api/v1/tasks/assignment/${assignmentId}/progress`),
};